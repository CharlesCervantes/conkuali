...
import { editarProyectoAction } from "@/app/(app)/control-de-obra/actions";
...
export default async function EditarProyectoPage({
  ...
  // % Utilidad/Administración por default es información privada — nunca se
  // manda al cliente ni se renderiza en el form si el usuario no tiene el
  // permiso, aunque el esquema ya esté bloqueado (corrección de sesión,
  // agosto 2026).
      ...
      <Card className="enter p-6">
        <ProyectoForm
          ...
          valoresIniciales={{
            ...
            porcentajeUtilidadDefault: puedeVerPrivado
              ? (proyecto.porcentajeUtilidadDefault?.toString() ?? null)
              : null,
            // Sin gate de Vista Privada — ver mismo comentario en
            // proyecto-form.tsx.
